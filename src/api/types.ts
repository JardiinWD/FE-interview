...
export type TCartApiContext = 'getCarts' | 'getCartById' | 'getCartByUserId' | 'addCart' | 'updateCart' | 'deleteCart';
...
export interface ICartApi {
    ...
    handleCartErrors: (error: TPromiseError, context: TCartApiContext) => Promise<ICartPromise>;
}
...
export interface IProductApi {
    ...
    handleProductErrors: (error: TPromiseError, context: TProductApiContext) => Promise<IProductPromise>;
    // TODO : Remove optional cases, now for developing purpose
